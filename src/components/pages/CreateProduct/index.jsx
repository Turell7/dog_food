...
//   const [pictures, setPictures] = useState('')
  ...
  //   const createNewProduct = (values) => api.createProduct(values)
  //     .then((res) => {
  ...
  const { mutate } = useMutation({
    ...
    onSubmit: () => {
      queryClient.invalidateQueries({ queryKey: CREATE_PRODUCT })
    },
  })

  return (
    <>
      <h1>Доброго времени суток! К сожалению эта страница еще не готова к использованию...</h1>
      <Formik
        initialValues={{
          name: '',
          price: '',
